...
import { ApartmentTypeComponent } from 'app/entities/apartment-type/apartment-type.component';
...
describe('Component Tests', () => {
    describe('ApartmentType Management Component', () => {
        let comp: ApartmentTypeComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ApartmentTypeComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.apartmentTypes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
