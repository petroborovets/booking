...
describe('Service Tests', () => {
    describe('PropertyType Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(PropertyTypeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/property-types';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a PropertyType', () => {
                service.create(new PropertyType(null)).subscribe(received => {
            ...
            it('should update a PropertyType', () => {
                service.update(new PropertyType(123)).subscribe(received => {
            ...
            it('should return a PropertyType', () => {
            ...
            it('should return a list of PropertyType', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new PropertyType(123)]);
            });
